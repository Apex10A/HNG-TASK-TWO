  ...
  return (
    <div className='flex flex-col items-center py-10 px-10 min-h-screen justify-center bg-[#fbf4f5] w-full'>
      ...
      <div className='bg-[#fff] my-4 py-10 px-8 rounded-lg'>
        <div className='pb-6'>
            <p className='semibold text-sm'>Transfer to the account details below</p>
        </div>
        <div className='pb-5'>
            <p className='paragraph text-[#5b4e50] text-sm pb-2'>Bank Name</p>
            <p className='semibold'>Sterling Bank</p>
        </div>
        <div className='flex items-center justify-between'>
        <div className='pb-5'>
            <p className='paragraph text-[#5b4e50] text-sm pb-2'>Account Number</p>
        ...
        <div>
            <p className='paragraph text-[#5b4e50] text-sm pb-2'>Account Name</p>
        ...
        <div className='flex items-center justify-between'>
            <div>
                ...
                <p className='paragraph text-[#5b4e50] text-sm pb-2'>Amount to Pay</p>
