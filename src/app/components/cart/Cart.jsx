      ...
      <div className='md:flex justify-center md:gap-10 bg-[#fbf4f5] py-10'>
        <div className=''>
          ...
          <div className='w-[90%] flex items-center justify-center mx-auto'>
            <Image src={CartImageOne} alt='' className='max-w-sm hidden md:flex' />
            <Image src={MobileCart} alt='' className='max-w-sm md:hidden flex' />
          </div>
        ...
        <div>
          ...
          <div className='max-w-xl py-6 px-5'>
            <p className='leading-[30px] pb-3 opacity-[0.9] text-sm'>Medix 5.5 Glycolic and Lactic Acid Body Moisturizer is dermatologist-tested and formulated to provide maximum benefits without compromising on gentleness. Perfect for all skin types, it’s your go-to solution for achieving healthier, glowing skin.</p>
            <div>
